...
'''
# the custom command can be called using `python manage.py create_science_and_nature_objects 17 "Science & Nature"` to populate Science & Nature
...
class Command(BaseCommand):
    ...
    # create an object for the sub-category (e.g.science_and_nature) quiz data
    def handle(self, *args: Any, **options):        
        category_id = options['category_id']
        category_name = options['category_name']

        # call the get_specific_json_category function to get the data for the science_and_nature category
                ...
                for idx, question in enumerate(questions, start=1):                
                    ...
                    if model != None: ##            
                        ...
                        question_object = model.objects.create(category = education_category_obj,
                                                               subcategory = science_and_nature_subcategory_obj,
