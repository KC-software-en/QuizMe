...
# import models
from ...models import Categories, Subcategories, Music
                ...
                for idx, question in enumerate(questions, start=1):                
                    ...
                    if model != None: ##     
                        ...
                        if category_created == True:
                            self.stdout.write(self.style.SUCCESS(f"Created the Entertainment category for Music objects."))

                        else:
                            self.stdout.write(self.style.NOTICE(f"The Entertainment category for Music objects already exists."))

                        # retrieve the subcategory object representing 'Music' from the Subcategories model
                        music_subcategory_obj, subcategory_created = Subcategories.objects.get_or_create(subcategory='Music')

                        # check if the subcategory was created or indicate that it already exists
                        if subcategory_created == True:
                            self.stdout.write(self.style.SUCCESS(f"Created the Music subcategory for Music objects."))

                        else:
                            self.stdout.write(self.style.NOTICE(f"The Music subcategory for Music objects already exists."))
                        ...
                        # use get_or_create in the event music objects are already in the db
                        ...
                        question_object, _ = model.objects.get_or_create(category = entertainment_category_obj,
                                                               subcategory = music_subcategory_obj,
