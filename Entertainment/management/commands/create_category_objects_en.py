...
# `python manage.py create_category_objects_en 11 Film` to populate Film
# `python manage.py create_category_objects_en 12 Music` to populate Music
# `python manage.py create_category_objects_en 15 "Video Games"` to populate Video Games
